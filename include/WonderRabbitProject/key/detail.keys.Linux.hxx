...
, std::make_tuple("super", KEY_CYCLEWINDOWS)
, std::make_tuple("windows", KEY_CYCLEWINDOWS)
, std::make_tuple("command", KEY_CYCLEWINDOWS)
, std::make_tuple("left windows", KEY_CYCLEWINDOWS)
, std::make_tuple("right windows", KEY_CYCLEWINDOWS)
