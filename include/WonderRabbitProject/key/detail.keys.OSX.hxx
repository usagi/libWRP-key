...
, std::make_tuple("f21", -1)
, std::make_tuple("f22", -2)
, std::make_tuple("f23", -3)
, std::make_tuple("f24", -4)
, std::make_tuple("zenkaku/hankaku", -5)
...
, std::make_tuple("left meta", -6)
, std::make_tuple("right meta", -7)
, std::make_tuple("muhenkan", -8)
, std::make_tuple("henkan", -9)
, std::make_tuple("katakana hiragana", -10)
, std::make_tuple("super", kVK_Command)
, std::make_tuple("windows", kVK_Command)
, std::make_tuple("command", kVK_Command)
, std::make_tuple("menu", -11)
...
, std::make_tuple("print screen", -12)
, std::make_tuple("scroll lock", -13)
, std::make_tuple("pause", -14)
, std::make_tuple("insert", -15)
, std::make_tuple("delete", -16)
...
, std::make_tuple("up", UpArrow)
, std::make_tuple("left", LeftArrow)
, std::make_tuple("down", DownArrow)
, std::make_tuple("right", RightArrow)
, std::make_tuple("num lock", -17)
...
, std::make_tuple("num plusminus", -18)
, std::make_tuple("num left paren", -19)
, std::make_tuple("num right paren", -20)
, std::make_tuple("mute", kVK_Mute)
, std::make_tuple("volume down", kVK_VolumeDown)
, std::make_tuple("volume up", kVK_VolumeUp)
, std::make_tuple("power", -21)
, std::make_tuple("sleep", -22)
, std::make_tuple("wake up", -23)
, std::make_tuple("screen lock", -24)
, std::make_tuple("www", -25)
, std::make_tuple("mail", -26)
, std::make_tuple("play pause", -27)
, std::make_tuple("next song", -28)
, std::make_tuple("previous song", -29)
, std::make_tuple("wlan", -30)
, std::make_tuple("bluetooth", -31)
, std::make_tuple("brightness down", -32)
, std::make_tuple("brightness up", -33)
, std::make_tuple("display off", -34)
, std::make_tuple("function", -35)
};
